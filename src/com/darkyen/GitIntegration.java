...
final class GitIntegration {
    ...
    private static final String DTT_TIME_FILE_NAME = ".darkyenus_time_tracker";
    ...
    private static final String TIME_TRACKER_HOOK_IDENTIFIER = "#DarkyenusTimeTrackerHookScript_";
